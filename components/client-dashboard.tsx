...
interface ClientDashboardProps {
  ...
  currentUser: any
  categories: any // ✅ SYNC: Receives updated categories from Admin Dashboard
}
...
export function ClientDashboard({ tickets, onTicketCreate, currentUser, categories }: ClientDashboardProps) {
  ...
  // ✅ SYNC: Filter tickets for current user - shows tickets created by this user
  ...
  // ✅ SYNC: Handle ticket creation - syncs to Admin Dashboard
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={ticketDialogOpen} onOpenChange={setTicketDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto font-iran" dir="rtl">
            ...
            {/* ✅ SYNC: Pass updated categories to form - receives real-time updates from Admin */}
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto font-iran" dir="rtl">
          ...
          {selectedTicket && (
            <div className="space-y-6">
              ...
              {/* ✅ SYNC: Responses - shows updates from technicians in real-time */}

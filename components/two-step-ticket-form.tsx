          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-medium">
                {watchedValues.mainIssue && categories[watchedValues.mainIssue]
                  ? categories[watchedValues.mainIssue].label
                  : "انتخاب نشده"}
              </span>
            </div>
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-medium">
                ...
                categories[watchedValues.mainIssue]?.subIssues[watchedValues.subIssue]
                  ? categories[watchedValues.mainIssue].subIssues[watchedValues.subIssue].label
                  : "انتخاب نشده"}
              </span>
            </div>
          </div>

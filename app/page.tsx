...
// Initial categories data - moved from category-management component
...
export default function ITServiceDashboard() {
  ...
  // Handle ticket creation - syncs to Admin Dashboard
  const handleTicketCreate = (newTicket: any) => {
    ...
    // Update tickets state - this will sync to all dashboards
  ...
  // Handle ticket updates - syncs between all dashboards
  ...
  // Handle category updates - syncs to Client Dashboard
